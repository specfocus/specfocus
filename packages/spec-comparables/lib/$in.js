...
exports.checkIn = exports.$in = void 0;
...
var checkIn = function (val, expr, error) {
    ...
    if (Array.isArray(expr)) {
        ...
        if (test_1.includes(val))
            return true;
        error("Expected ".concat(val, " to be in ").concat(test_1));
    }
    else {
        var _d = expr, _e = exports.$in, test_2 = _d[_e];
        ...
        if (test_2.includes(val))
            return true;
        error("Expected ".concat(val, " to be in ").concat(test_2));
    }
    return false;
};
