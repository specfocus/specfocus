...
var xand_1 = __importDefault(require("./xand"));
...
var verifyComparison = function (val, expr, error) {
    ...
    return Object.entries(expr).reduce(function (result, _a) {
        ...
        switch ($tag) {
            case _eq_1.$eq:
                result = (0, xand_1.default)(result, (0, _eq_1.checkEqualTo)(val, (_b = {}, _b[$tag] = test, _b), error));
                break;
            case _gt_1.$gt:
                result = (0, xand_1.default)(result, (0, _gt_1.checkGreaterThan)(val, (_c = {}, _c[$tag] = test, _c), error));
                break;
            case _gte_1.$gte:
                result = (0, xand_1.default)(result, (0, _gte_1.checkGreaterThanOrEqualTo)(val, (_d = {}, _d[$tag] = test, _d), error));
                break;
            case _in_1.$in:
                result = (0, xand_1.default)(result, (0, _in_1.checkIn)(val, (_e = {}, _e[$tag] = test, _e), error));
                break;
            case _lt_1.$lt:
                result = (0, xand_1.default)(result, (0, _lt_1.checkLessThan)(val, (_f = {}, _f[$tag] = test, _f), error));
                break;
            case _lte_1.$lte:
                result = (0, xand_1.default)(result, (0, _lte_1.checkLessThanOrEqualTo)(val, (_g = {}, _g[$tag] = test, _g), error));
                break;
            case _neq_1.$ne:
                result = (0, xand_1.default)(result, (0, _neq_1.checkNotEqualTo)(val, (_h = {}, _h[$tag] = test, _h), error));
                break;
            case _nin_1.$nin:
                result = (0, xand_1.default)(result, (0, _nin_1.checkNotIn)(val, (_j = {}, _j[$tag] = test, _j), error));
                break;
        }
        return result;
    }, undefined);
