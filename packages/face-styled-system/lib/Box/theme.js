...
import coerceFromString from "../utils/coerceFromString";
export const hasMtProp = ({ marginTop, mt, my, m, margin }) => marginTop || mt || my || m || margin;
export const hasMbProp = ({ marginBottom, mb, my, m, margin }) => marginBottom || mb || my || m || margin;
