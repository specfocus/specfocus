...
exports.xor = xor;
var verifyOr = function (val, expr, error, fallback) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_h) {
        switch (_h.label) {
            case 0:
                ...
                if (expr.length < 2 || $tag !== exports.$or)
                    return [2 /*return*/];
                verification = void 0;
                if (expr.length === 2) {
            ...
            case 3:
                ...
                result = (0, exports.xor)(result, partialResult);
                _h.label = 4;
            case 4:
            ...
            case 9:
                _b = expr, _c = exports.$or, verification = _b[_c];
                if (!Array.isArray(verification))
                    return [2 /*return*/];
                result = undefined;
                _h.label = 10;
