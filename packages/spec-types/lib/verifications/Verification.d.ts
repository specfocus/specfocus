...
export declare const verify: <V extends Valuable, E = Verification<V, Comparison<V> | TaggedComparison<V>>>(val: V | V[], expr: E, error: (msg: string) => void, fallback?: Verify<V, E> | undefined) => Promise<boolean | undefined>;
