...
;
var BooleanClass = /** @class */ (function (_super) {
    __extends(BooleanClass, _super);
    function BooleanClass() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    BooleanClass[Symbol.iterator] = function () {
        return iterate(this);
    };
    Object.defineProperty(BooleanClass, "defived", {
        get: function () {
    ...
    BooleanClass.registerDerived = function (derived) {
        this.derivedClasses.push(derived);
    };
    BooleanClass.prototype.valueOf = function (val) {
        val = (0, value_of_1.default)(val);
        if ((0, has_boolean_type_1.default)(val))
            return val;
        return undefined;
    };
    BooleanClass.prototype.validate = function (value, error) {
        var e_3, _a;
        ...
        if ((0, has_boolean_type_1.default)(value))
            return true;
        error("Expected a boolean, but got ".concat(typeof value, "."));
        return false;
    };
    ;
    ...
    BooleanClass.derivedClasses = [];
    return BooleanClass;
}(Enumify_1.Enumify));
exports.BooleanClass = BooleanClass;
Enumify_1.Enumify.seal(BooleanClass);
