...
exports.checkGreaterThan = exports.$gt = void 0;
...
var checkGreaterThan = function (val, expr, error) {
    ...
    if (Array.isArray(expr)) {
        ...
        var _b = expr, _c = exports.$gt, test_2 = _b[_c];
        ...
        if (val > test_2)
            return true;
        error("Expected ".concat(val, " to be greater than ").concat(test_2));
    }
    return false;
};
