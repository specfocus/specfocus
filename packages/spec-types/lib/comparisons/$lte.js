...
exports.checkLessThanOrEqualTo = exports.$lte = void 0;
...
exports.$lte = '$lte';
var checkLessThanOrEqualTo = function (val, expr, error) {
    if (!(0, has_object_type_1.default)(expr))
        return;
    if (Array.isArray(expr)) {
        var _a = __read(expr, 2), $tag = _a[0], test_1 = _a[1];
        if ($tag !== exports.$lte || expr.length !== 2)
            return;
        ...
        var _b = expr, _c = exports.$lte, test_2 = _b[_c];
        ...
        if (val <= test_2)
            return true;
        error("Expected ".concat(val, " to be less than or equal to ").concat(test_2));
    }
    return false;
};
exports.checkLessThanOrEqualTo = checkLessThanOrEqualTo;
