...
var Fieldset_verify_1 = __importDefault(require("./Fieldset.verify"));
describe('verifyFieldset', function () {
    ...
    var fieldset = {
        ...
        members: { $type: 'number', $exists: false, $nullable: false, $spec: ['number', { $class: 'Integer', $gte: 0, $lte: 100 }] },
        points: { $type: 'number', $exists: false, $nullable: false, $spec: ['number', { $class: 'Fibonnaci', $gte: 0, $lte: 100 }] },
