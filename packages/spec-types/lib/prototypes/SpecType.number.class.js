...
var NumberClass = /** @class */ (function (_super) {
    ...
    NumberClass[Symbol.iterator] = function () {
        return iterate(this);
    };
    Object.defineProperty(NumberClass, "defived", {
        get: function () {
    ...
    NumberClass.prototype.validate = function (value, error) {
        ...
        if ((0, is_valid_number_1.default)(value))
            return true;
        error("Expected a number, but got ".concat(typeof value, "."));
        return false;
    };
    NumberClass.extend = function (base) {
    ...
    NumberClass.derivedClasses = [];
    return NumberClass;
}(Enumify_1.Enumify));
exports.NumberClass = NumberClass;
Enumify_1.Enumify.seal(NumberClass);
