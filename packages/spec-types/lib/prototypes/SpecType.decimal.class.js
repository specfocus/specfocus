...
;
var DecimalClass = /** @class */ (function (_super) {
    __extends(DecimalClass, _super);
    function DecimalClass() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    DecimalClass[Symbol.iterator] = function () {
        return iterate(this);
    };
    Object.defineProperty(DecimalClass, "defived", {
        get: function () {
    ...
    DecimalClass.find = function (className) {
        return this.derivedClasses.find(function (item) { return item.name === className; });
    };
    DecimalClass.registerDerived = function (derived) {
        this.derivedClasses.push(derived);
    };
    DecimalClass.prototype.validate = function (value, error) {
        var e_3, _a;
    ...
    DecimalClass.prototype.valueOf = function (val) {
        val = (0, value_of_1.default)(val);
        if ((0, has_number_type_1.default)(val) && (0, is_valid_number_1.default)(val))
            return val;
        return undefined;
    };
    DecimalClass.extend = function (base) {
    ...
    DecimalClass.derivedClasses = [];
    return DecimalClass;
}(Enumify_1.Enumify));
exports.DecimalClass = DecimalClass;
Enumify_1.Enumify.seal(DecimalClass);
