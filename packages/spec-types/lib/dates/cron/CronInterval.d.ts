...
export declare const cronIntervalSpec: <V extends number = number>(offset: CronValue<V, import("./CronObjectSpec").CronValueSpec<V>> | CronRange<V>, step: PositiveInteger) => readonly ["i", import("./CronObjectSpec").CronValueSpec<V> | readonly ["r", import("./CronObjectSpec").CronValueSpec<V>, import("./CronObjectSpec").CronValueSpec<V>], number];
 ...
 */
declare const interval: <V extends number = number>(expr: string, scope: Scope<V>, offset: (expr: string, scope: Scope<V>) => CronValue<V, import("./CronObjectSpec").CronValueSpec<V>> | CronRange<V> | undefined) => CronInterval<V> | undefined;
